...
Calendar._TT["PREV_YEAR"] = "سال قبل (نگه دارید-لیست)";
Calendar._TT["PREV_MONTH"] = "ماه قبل (نگه دارید-لیست)";
Calendar._TT["GO_TODAY"] = "رفتن به امروز";
Calendar._TT["NEXT_MONTH"] = "ماه بعد (نگه دارید-لیست)";
Calendar._TT["NEXT_YEAR"] = "سال بعد (نگه دارید-لیست)";
Calendar._TT["SEL_DATE"] = "انتخاب تاریخ";
Calendar._TT["DRAG_TO_MOVE"] = "بکشید";
