...
student_list_connection.get_grid_call_back = function (data) {
    ...
    grid_student_list.cols = [
        {name: 'ID', hidden: true, type: 'text'}, {name: 'student_id', hidden: false, type: 'text'}, {
            name: 'user_id',
            hidden: true,
            type: 'text'
    ...
    grid_student_list.actions = [{
        ...
        attribute: [{name: 'onclick', value: "delete_user(this,'delete_student_all')"}]
    }
    ];
...
student_list_connection.edit_ID_by_ID = function (ID, ID) {
    var param = {
        "act": "student_list_edit_ID_by_ID",
        ID: ID,
        ID: ID
    };
...
student_list_connection.edit_student_id_by_ID = function (ID, student_id) {
    var param = {
        "act": "student_list_edit_student_id_by_ID",
        student_id: student_id,
        ID: ID
    };
...
student_list_connection.edit_user_id_by_ID = function (ID, user_id) {
    var param = {
        "act": "student_list_edit_user_id_by_ID",
        user_id: user_id,
        ID: ID
    };
...
student_list_connection.edit_grade_id_by_ID = function (ID, grade_id) {
    var param = {
        "act": "student_list_edit_grade_id_by_ID",
        grade_id: grade_id,
        ID: ID
    };
...
student_list_connection.edit_field_of_study_id_by_ID = function (ID, field_of_study_id) {
    var param = {
        "act": "student_list_edit_field_of_study_id_by_ID",
        field_of_study_id: field_of_study_id,
        ID: ID
    };
...
student_list_connection.edit_year_id_by_ID = function (ID, year_id) {
    var param = {
        "act": "student_list_edit_year_id_by_ID",
        year_id: year_id,
        ID: ID
    };
...
student_list_connection.edit_name_by_ID = function (ID, name) {
    var param = {
        "act": "student_list_edit_name_by_ID",
        name: name,
        ID: ID
    };
...
student_list_connection.edit_lastname_by_ID = function (ID, lastname) {
    var param = {
        "act": "student_list_edit_lastname_by_ID",
        lastname: lastname,
        ID: ID
    };
...
student_list_connection.edit_national_code_by_ID = function (ID, national_code) {
    var param = {
        "act": "student_list_edit_national_code_by_ID",
        national_code: national_code,
        ID: ID
    };
