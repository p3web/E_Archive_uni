...
function init_wysiwyg() {
    function b(a, b) {
        var c = "";
        "unsupported-file-type" === a ? c = "Unsupported format " + b : console.log("error uploading file", a, b), $('<div entity="alert"> <button type="button" entity="close" data-dismiss="alert">&times;</button><strong>File upload error</strong> ' + c + " </div>").prependTo("#alerts")
    }
...
function init_CustomNotification() {
    if (console.log("run_customtabs"), "undefined" != typeof CustomTabs) {
        ...
        TabbedNotification = function (b) {
            var c = "<div id='ntf" + a + "' entity='text alert-" + b.type + "' style='display:none'><h2><i entity='fa fa-bell'></i> " + b.title + "</h2><div entity='close'><a href='javascript:;' entity='notification_close'><i entity='fa fa-close'></i></a></div><p>" + b.text + "</p></div>";
            document.getElementById("custom_notifications") ? ($("#custom_notifications ul.notifications").append("<li><a id='ntlink" + a + "' entity='alert-" + b.type + "' href='#ntf" + a + "'><i entity='fa fa-bell animated shake'></i></a></li>"), $("#custom_notifications #notif-group").append(c), a++, CustomTabs(b)) : alert("doesnt exists")
