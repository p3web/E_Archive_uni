...
student_connection.set = function (user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by) {
    var param = {
        act: "student_set",
        user_id: user_id,
...
student_connection.get_grid_call_back = function (data) {
    ...
    grid_student.cols = [
        {name: 'ID', hidden: true, type: 'text'}, {name: 'user_id', hidden: false, type: 'text'}, {
            name: 'student_id',
            hidden: false,
            type: 'text'
        }, {name: 'directory_id', hidden: true, type: 'text'}, {
            name: 'grade_id',
            hidden: true,
            type: 'text'
            ...
            hidden: true,
            type: 'text'
        }, {name: 'accept_unit', hidden: true, type: 'text'}, {
            name: 'term_graduate',
            hidden: true,
            type: 'text'
        }, {name: 'average', hidden: true, type: 'text'}, {
            name: 'system_type',
            hidden: true,
            type: 'text'
        }, {name: 'date_graduate', hidden: true, type: 'text'}, {
            name: 'created_by',
            hidden: true,
            type: 'text'
...
student_connection.get_by_directory_id_call_back = function (data) {
    //TODO: set code after the server response
    if (student_connection.debug_mode) {
        console.log(data);
    }
};
student_connection.get_by_directory_id = function (directory_id) {
    var param = {
        "act": "student_get_by_directory_id",
        directory_id: directory_id
    };
    ajax.sender_data_json_by_url_callback(student_connection.controller_url, param, student_connection.get_by_directory_id_call_back, "POST");
};

student_connection.get_by_directory_id_grid = function (directory_id) {
    var param = {
        "act": "student_get_by_directory_id",
        directory_id: directory_id
    };
...
student_connection.edit_by_ID = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_user_id = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_student_id = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_directory_id_call_back = function (data) {
    //TODO: set code after the server response
    if (student_connection.debug_mode) {
        console.log(data);
    }
};
student_connection.edit_by_directory_id = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
        "act": "student_edit_by_directory_id",
        ID: ID,
        user_id: user_id,
        student_id: student_id,
        directory_id: directory_id,
    ...
    ajax.sender_data_json_by_url_callback(student_connection.controller_url, param, student_connection.edit_by_directory_id_call_back, "POST");
};
student_connection.edit_directory_id_by_ID_call_back = function (data) {
    //TODO: set code after the server response
    if (student_connection.debug_mode) {
        console.log(data);
    }
};
student_connection.edit_directory_id_by_ID = function (ID, directory_id) {
    var param = {
        "act": "student_edit_directory_id_by_ID",
        directory_id: directory_id,
        ID: ID
    };
    ajax.sender_data_json_by_url_callback(student_connection.controller_url, param, student_connection.edit_directory_id_by_ID_call_back, "POST");
};
...
student_connection.edit_by_grade_id = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_field_of_study_id = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_transfer_unit = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_accept_unit = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_term_graduate = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_average = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_system_type = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_date_graduate = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_created_by = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
...
student_connection.edit_by_creationDate = function (ID, user_id, student_id, directory_id, grade_id, field_of_study_id, transfer_unit, accept_unit, term_graduate, average, system_type, date_graduate, created_by, creationDate) {
    var param = {
