        ...
        files_connection.get = function (){
         ...
         files_connection.set = function (owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by){
       ...
       // grid_files.actions = [{name: 'delete', ClassName: 'glyphicon glyphicon-remove', attribute: {onclick: 'deleteIt()'}}];
        ...
        files_connection.get_by_owner_id_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.get_by_owner_id = function (owner_id){
                var param = {"act": "files_get_by_owner_id",
            owner_id : owner_id
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_by_owner_id_call_back , "POST");
        };

        files_connection.get_by_owner_id_grid = function (owner_id){
                var param = {"act": "files_get_by_owner_id",
            owner_id : owner_id
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_grid_call_back , "POST");
        ...
        files_connection.get_by_name = function (name){
                var param = {"act": "files_get_by_name",
            name : name
            };
        ...
        files_connection.get_by_parentdir_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.get_by_parentdir = function (parentdir){
                var param = {"act": "files_get_by_parentdir",
            parentdir : parentdir
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_by_parentdir_call_back , "POST");
        };

        files_connection.get_by_parentdir_grid = function (parentdir){
                var param = {"act": "files_get_by_parentdir",
            parentdir : parentdir
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_grid_call_back , "POST");
        ...
        files_connection.get_by_url = function (url){
                var param = {"act": "files_get_by_url",
            url : url
            };
        ...
        files_connection.get_by_property = function (property){
                var param = {"act": "files_get_by_property",
            property : property
            };
        ...
        files_connection.get_by_lat_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.get_by_lat = function (lat){
                var param = {"act": "files_get_by_lat",
            lat : lat
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_by_lat_call_back , "POST");
        };

        files_connection.get_by_lat_grid = function (lat){
                var param = {"act": "files_get_by_lat",
            lat : lat
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_grid_call_back , "POST");
        };
        files_connection.get_by_lng_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.get_by_lng = function (lng){
                var param = {"act": "files_get_by_lng",
            lng : lng
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_by_lng_call_back , "POST");
        };

        files_connection.get_by_lng_grid = function (lng){
                var param = {"act": "files_get_by_lng",
            lng : lng
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.get_grid_call_back , "POST");
        ...
        files_connection.get_by_size = function (size){
                var param = {"act": "files_get_by_size",
            size : size
            };
        ...
        files_connection.get_by_is_delete = function (is_delete){
                var param = {"act": "files_get_by_is_delete",
            is_delete : is_delete
            };
        ...
        files_connection.get_by_modified_by = function (modified_by){
                var param = {"act": "files_get_by_modified_by",
        ...
        files_connection.edit_by_ID = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
        ...
        };files_connection.edit_by_owner_id_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_by_owner_id = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_owner_id",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_by_owner_id_call_back , "POST");
        };files_connection.edit_owner_id_by_ID_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_owner_id_by_ID = function (ID, owner_id){
                var param = {"act": "files_edit_owner_id_by_ID",
            owner_id : owner_id,
            ID : ID
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_owner_id_by_ID_call_back , "POST");
        ...
        files_connection.edit_by_name = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_name",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
        ...
        files_connection.edit_name_by_ID = function (ID, name){
                var param = {"act": "files_edit_name_by_ID",
            name : name,
            ID : ID
            };
        ...
        files_connection.edit_by_type = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
        ...
        };files_connection.edit_by_parentdir_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_by_parentdir = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_parentdir",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_by_parentdir_call_back , "POST");
        };files_connection.edit_parentdir_by_ID_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_parentdir_by_ID = function (ID, parentdir){
                var param = {"act": "files_edit_parentdir_by_ID",
            parentdir : parentdir,
            ID : ID
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_parentdir_by_ID_call_back , "POST");
        ...
        files_connection.edit_by_url = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_url",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
        ...
        files_connection.edit_url_by_ID = function (ID, url){
                var param = {"act": "files_edit_url_by_ID",
            url : url,
            ID : ID
            };
        ...
        files_connection.edit_by_property = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_property",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
        ...
        files_connection.edit_property_by_ID = function (ID, property){
                var param = {"act": "files_edit_property_by_ID",
            property : property,
            ID : ID
            };
        ...
        };files_connection.edit_by_lat_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_by_lat = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_lat",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_by_lat_call_back , "POST");
        };files_connection.edit_lat_by_ID_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_lat_by_ID = function (ID, lat){
                var param = {"act": "files_edit_lat_by_ID",
            lat : lat,
            ID : ID
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_lat_by_ID_call_back , "POST");
        };files_connection.edit_by_lng_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_by_lng = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_lng",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_by_lng_call_back , "POST");
        };files_connection.edit_lng_by_ID_call_back = function (data){
                //TODO: set code after the server response
                if(files_connection.debug_mode){
                    console.log(data);
                }
            };
        files_connection.edit_lng_by_ID = function (ID, lng){
                var param = {"act": "files_edit_lng_by_ID",
            lng : lng,
            ID : ID
            };
            ajax.sender_data_json_by_url_callback(files_connection.controller_url , param , files_connection.edit_lng_by_ID_call_back , "POST");
        ...
        files_connection.edit_by_size = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_size",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
        ...
        files_connection.edit_size_by_ID = function (ID, size){
                var param = {"act": "files_edit_size_by_ID",
            size : size,
            ID : ID
            };
        ...
        files_connection.edit_by_is_delete = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_is_delete",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
        ...
        files_connection.edit_is_delete_by_ID = function (ID, is_delete){
                var param = {"act": "files_edit_is_delete_by_ID",
            is_delete : is_delete,
            ID : ID
            };
        ...
        files_connection.edit_by_modified_by = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
                var param = {"act": "files_edit_by_modified_by",
            ID : ID ,owner_id : owner_id ,name : name ,type : type ,parentdir : parentdir ,url : url ,property : property ,lat : lat ,lng : lng ,size : size ,is_delete : is_delete ,modified_by : modified_by ,created_by : created_by ,creationDate : creationDate
            };
        ...
        files_connection.edit_modified_by_by_ID = function (ID, modified_by){
                var param = {"act": "files_edit_modified_by_by_ID",
            modified_by : modified_by,
            ID : ID
            };
        ...
        files_connection.edit_by_created_by = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
        ...
        files_connection.edit_by_creationDate = function (ID,owner_id,name,type,parentdir,url,property,lat,lng,size,is_delete,modified_by,created_by,creationDate){
