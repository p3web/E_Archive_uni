<?php
    ...
    switch ($_REQUEST['act']) {
        ...
        break;
            ...
            case 'student_get_by_directory_id':
                if(!isset($userAccess["get_student"]) && !$debugMode ){
                    controller_main_function::send_msg(lang::$not_access, lang::$error);
                    }
                ...
                $result = access_student::get_student_by_directory_id($_REQUEST["directory_id"]);
                controller_main_function::send_result($result);
            break;
            ...
            if(!isset($userAccess["edit_student"]) && !$debugMode ){
                ...
                $valid_data = controller_main_function::check_validation(array("ID" ,"user_id" ,"student_id" ,"directory_id" ,"grade_id" ,"field_of_study_id" ,"transfer_unit" ,"accept_unit" ,"term_graduate" ,"average" ,"system_type" ,"date_graduate" ,"created_by" ,"creationDate"));
                if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                    controller_main_function::send_msg(lang::$invalid_data, lang::$error);
                }
                $result = access_student::edit_student($_REQUEST["ID"],$_REQUEST["user_id"],$_REQUEST["student_id"],$_REQUEST["directory_id"],$_REQUEST["grade_id"],$_REQUEST["field_of_study_id"],$_REQUEST["transfer_unit"],$_REQUEST["accept_unit"],$_REQUEST["term_graduate"],$_REQUEST["average"],$_REQUEST["system_type"],$_REQUEST["date_graduate"],$_REQUEST["created_by"],$_REQUEST["creationDate"]);
                //controller_main_function::send_result($result);
            ...
            case 'student_edit_by_directory_id':
            if(!isset($userAccess["edit_student"]) && !$debugMode){
                    controller_main_function::send_msg(lang::$not_access, lang::$error);
                    }
                $valid_data = controller_main_function::check_validation(array("ID" ,"user_id" ,"student_id" ,"directory_id" ,"grade_id" ,"field_of_study_id" ,"transfer_unit" ,"accept_unit" ,"term_graduate" ,"average" ,"system_type" ,"date_graduate" ,"created_by" ,"creationDate"));
                ...
                $result = access_student::edit_student_by_directory_id($_REQUEST["ID"],$_REQUEST["user_id"],$_REQUEST["student_id"],$_REQUEST["directory_id"],$_REQUEST["grade_id"],$_REQUEST["field_of_study_id"],$_REQUEST["transfer_unit"],$_REQUEST["accept_unit"],$_REQUEST["term_graduate"],$_REQUEST["average"],$_REQUEST["system_type"],$_REQUEST["date_graduate"],$_REQUEST["created_by"],$_REQUEST["creationDate"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
            ...
            case 'student_edit_directory_id_by_ID':
            if(!isset($userAccess["edit_student"]) && !$debugMode){
                    controller_main_function::send_msg(lang::$not_access, lang::$error);
                    }
                $valid_data = controller_main_function::check_validation(array("ID","directory_id"));
                if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                    controller_main_function::send_msg(lang::$invalid_data, lang::$error);
                }
                $result = access_student::edit_student_directory_id_by_ID($_REQUEST["ID"],$_REQUEST["directory_id"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
            ...
            if(!isset($userAccess["set_student"]) && !$debugMode){
                ...
                $valid_data = controller_main_function::check_validation(array("user_id" ,"student_id" ,"directory_id" ,"grade_id" ,"field_of_study_id" ,"transfer_unit" ,"accept_unit" ,"term_graduate" ,"average" ,"system_type" ,"date_graduate" ,"created_by"));
                if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                    controller_main_function::send_msg(lang::$invalid_data, lang::$error);
                }
                $result = access_student::set_student($_REQUEST["user_id"],$_REQUEST["student_id"],$_REQUEST["directory_id"],$_REQUEST["grade_id"],$_REQUEST["field_of_study_id"],$_REQUEST["transfer_unit"],$_REQUEST["accept_unit"],$_REQUEST["term_graduate"],$_REQUEST["average"],$_REQUEST["system_type"],$_REQUEST["date_graduate"],$_REQUEST["created_by"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
